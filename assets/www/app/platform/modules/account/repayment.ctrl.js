...
(function () {
    ...
    RePaymentCtrl.$inject = ['$rootScope', '$scope', '$interval', '$ionicLoading', '$ionicNativeTransitions', 'UserService', '$translate'];
    function RePaymentCtrl($rootScope, $scope, $interval, $ionicLoading, $ionicNativeTransitions, UserService, $translate) {
        var vm = this;
